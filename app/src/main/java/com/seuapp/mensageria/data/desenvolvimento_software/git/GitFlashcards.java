package com.seuapp.mensageria.data.desenvolvimento_software.git;
    ...
    public static List<Flashcard> getFlashcards() {
        ...
        lista.add(new Flashcard(
                ...
                "📌 Áreas/Estados do Git:\n" +
                        ...
                        "Selecino as alterações que farão parte do px commit. \n" +
                        "3️⃣ Repositório Local (.git) - git commit:\n"+
                        "Onde as versões são definitivamente armazendas."
        ));
