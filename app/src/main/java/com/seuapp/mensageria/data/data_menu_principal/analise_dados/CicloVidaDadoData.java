...
public class CicloVidaDadoData {
    ...
    public static Disciplina getDisciplina() {
        ...
        video01.add(new Conteudo("BI_CONCEITOS", "BI_CONCEITOS"));
        video01.add(new Conteudo("BI_SAD_ANALISES", "BI_SAD_ANALISES"));
        ...
        video02.add(new Conteudo("BI_ARQUITETURA", "BI_ARQUITETURA"));
        ...
        video04.add(new Conteudo("DW_TIPOS_CARACTERISTICAS", "DW_TIPOS_CARACTERISTICAS"));
        ...
        video05.add(new Conteudo("DW_PROCESSOS_ABORDAGENS", "DW_PROCESSOS_ABORDAGENS"));
        ...
        video06.add(new Conteudo("DW_MODELAGEM_DIMENSIONAL", "DW_MODELAGEM_DIMENSIONAL"));
        video06.add(new Conteudo("DW_INMON_KIMBALL", "DW_INMON_KIMBALL"));
        ...
        video07.add(new Conteudo("ETL_PROCESSO", "ETL_PROCESSO"));video07.add(new Conteudo("ETL_VS_ELT", "ETL_VS_ELT"));
        ...
        video08.add(new Conteudo("PIPELINE_CONCEITOS", "PIPELINE_CONCEITOS"));
        video08.add(new Conteudo("PIPELINE_BENEFICIOS", "PIPELINE_BENEFICIOS"));
        ...
        video09.add(new Conteudo("PIPELINE_BATCH_STREAM", "PIPELINE_BATCH_STREAM"));
        video09.add(new Conteudo("PIPELINE_VS_ETL", "PIPELINE_VS_ETL"));
        ...
        return new Disciplina("Ciclo de Vida do Dado - Coleta, Armazenamento e Processamento", secoes);
    }
}
